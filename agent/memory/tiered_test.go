...
func TestTieredStore_TierIsolation(t *testing.T) {
	...
	_ = store.Append(ctx, TieredEntry{Entry: Entry{Scope: scope, Content: "L0"}, Tier: Tier0Working})
	_ = store.Append(ctx, TieredEntry{Entry: Entry{Scope: scope, Content: "L1"}, Tier: Tier1LongTerm})
...
func TestTieredStore_Delete(t *testing.T) {
	...
	_ = store.Delete(ctx, Tier1LongTerm, scope, "test-1")
...
func TestTieredStore_ClearTier(t *testing.T) {
	...
	_ = store.Append(ctx, TieredEntry{Entry: Entry{Scope: scope, Content: "a"}, Tier: Tier0Working})
	_ = store.Append(ctx, TieredEntry{Entry: Entry{Scope: scope, Content: "b"}, Tier: Tier1LongTerm})

	_ = store.ClearTier(ctx, Tier0Working)
...
func TestTieredStore_GetUnprocessed(t *testing.T) {
	...
	_ = store.Append(ctx, TieredEntry{Entry: Entry{ID: "a", Scope: scope, Content: "x"}, Tier: Tier0Working})
	_ = store.Append(ctx, TieredEntry{Entry: Entry{ID: "b", Scope: scope, Content: "y"}, Tier: Tier0Working})

	// Mark "a" as processed
	_ = store.MarkProcessed(ctx, scope, []string{"a"})
...
func TestTieredManager_WriteAndConsolidate(t *testing.T) {
	...
	// 写入工作记忆
	_ = mgr.WriteWorking(ctx, scope, "用户使用 Go 语言进行后端开发", "test")
	_ = mgr.WriteWorking(ctx, scope, "你好", "test") // 应被 SKIP
...
func TestTieredManager_RetrieveMerged(t *testing.T) {
	...
	// 写入各层级
	_ = mgr.WriteWorking(ctx, scope, "L0 content", "test")
	_ = mgr.WriteLongTerm(ctx, Entry{Scope: scope, Content: "L1 content", Category: "fact"}, Tier0Working)
	_ = mgr.WriteEpisodic(ctx, Entry{Scope: scope, Content: "L2 scene"}, []string{"mem-1"})
	_ = mgr.WriteProfile(ctx, Entry{Scope: scope, Content: "L3 trait"})
...
func TestTieredManager_RunGC(t *testing.T) {
	...
	// 写入 L0 + 手动过期
	_ = mgr.WriteWorking(ctx, scope, "valid", "test")
	_ = store.Append(ctx, TieredEntry{
