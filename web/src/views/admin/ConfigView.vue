...
const catLabels = { chat: '对话', token: 'Token 配额', system: '系统', workflow: '工作流', memory_window: '记忆窗口', MemoryWindow: '记忆窗口', agent: 'Agent 生成', Agent: 'Agent 生成', llm: 'LLM 客户端', LLM: 'LLM 客户端', compaction: '会话压缩', Compaction: '会话压缩', other: '其它' }
