...
func (b *captureBus) PublishToolProgress(_ context.Context, _, _, _, _ string, _ any)         {}
func (b *captureBus) PublishToolResult(_ context.Context, _, _, _, _ string, _ any, _ string) {}
