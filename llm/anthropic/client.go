...
// Client 是 Anthropic API 客户端，封装 util/http.Client。
type Client struct {
...
// WithAPIVersion 设置 API 版本（默认 "2023-06-01"）。
...
// New 创建一个新的 Anthropic API Client。
func New(opts ...Option) *Client {
	...
	httpOpts := []httputil.Option{
		...
		httputil.WithHeader("x-api-key", cfg.apiKey),
		httputil.WithHeader("anthropic-version", cfg.version),
	}
	if cfg.timeout > 0 {
